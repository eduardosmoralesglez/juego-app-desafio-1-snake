...
INSERT INTO usuarios (user, email, username, password, id_nivel) VALUES 
    ('Usuario-1', 'email1@example.com', 'vegeta777','contraseña123', 1),  
    ('Usuario-2', 'email2@example.com', 'juanpedro313','abc456', 1), 
    ('Usuario-3', 'email3@example.com', 'lavidaesdura','xyz789', 1);  
